// Config file for Suckless's st terminal emulator.
...
static char **colorname = colorname_light;
...
static void switchcolor(const Arg *);
static void xloadcols(void);
static void redraw(void);


void switchcolor(const Arg *arg) {
  if (colorname == colorname_dark) colorname = colorname_light;
  else colorname = colorname_dark;
  xloadcols();
  redraw();
}
